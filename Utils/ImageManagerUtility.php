...
namespace AiraGroupSro\MicrobeImageManager\Utils;

use AiraGroupSro\MicrobeImageManager\File\UploadedFile;
use AiraGroupSro\ImageManager\Manager\ImageManager;
use AiraGroupSro\ImageManager\Image\ProcessedImageBag;
...
class ImageManagerUtility
{
    ...
    public function __construct($configuration){
        ...
        $this->autorotate = $configuration['autorotate'];
    }
